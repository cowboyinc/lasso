...
export const COMMAND_SPECS: CommandSpec[] = [
  { parserKey: "help", section: "General", usage: "help", summary: "Show this help", route: [literal("help")] },
  { parserKey: "clear", section: "General", usage: "clear", summary: "Clear the console", route: [literal("clear")] },
  { parserKey: "exit", section: "General", usage: "exit", summary: "Quit lasso", route: [literal("exit")] },
  { parserKey: "quit", section: "General", usage: "quit", summary: "Quit lasso", route: [literal("quit")] },
  {
    parserKey: "init",
    section: "General",
  ...
  },
  {
    parserKey: "actor-get",
    section: "Actor",
    usage: "actor get <address>",
    summary: "Get actor details",
    route: [literal("actor"), literal("get")],
    positionals: [{ name: "actor", valueKind: { type: "actor" } }],
  ...
  { parserKey: "actor-list", section: "Actor", usage: "actor list", summary: "List deployed actors", route: [literal("actor"), literal("list")] },
  {
    parserKey: "actor-logs",
    section: "Actor",
    usage: "actor logs <address>",
  ...
  { parserKey: "runner-list", section: "Runner", usage: "runner list", summary: "List all runners", route: [literal("runner"), literal("list")] },
  {
  ...
  {
    parserKey: "token-launch",
    section: "Token (CIP-20)",
    usage: "token launch",
    summary: "Interactive token creation wizard",
    route: [literal("token"), literal("launch")],
  },
  {
  ...
  { parserKey: "token-list", section: "Token (CIP-20)", usage: "token list", summary: "List all tokens", route: [literal("token"), literal("list")] },
  {
  ...
  { parserKey: "watchtower-list", section: "Watchtower", usage: "watchtower list", summary: "List all feeds", route: [literal("watchtower"), literal("list")] },
  { parserKey: "watchtower-feeds", section: "Watchtower", usage: "watchtower feeds", summary: "List your feeds", route: [literal("watchtower"), literal("feeds")] },
];
